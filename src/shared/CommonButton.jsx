  ...
  return (
    <div>
      <button type="submit">
        <Link
          to={NavigateLink}
          className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-White_Color rounded hover:bg-White_Color group border-[1px] border-Primary_Color"
        >
          ...
          <span className="relative w-full text-left  transition-colors duration-400 ease-in-out group-hover:text-White_Color">
            {ButtonName}
          </span>
        </Link>
      </button>
